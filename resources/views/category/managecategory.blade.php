              ...
              <table class="table table-bordered">
                ...
                @forelse ($categories as $category)
                  <tr>
                    ...
                    <td id="button">
                      <a href="{{ url('category/edit') }}/{{ $category->id }}" class="btn btn-success" style="margin-bottom:5px;">Edit</a>
                      <a href="{{ url('category/delete') }}/{{ $category->id }}" class="btn btn-danger" style="margin-bottom:5px;">Delete</a>
                    </td>
                  </tr>
                @empty
                  <tr>
